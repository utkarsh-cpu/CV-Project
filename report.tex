...
The implementation described in this report is available in the accompanying GitHub repository for this project. For reproducibility and easier access to the unified data resources used in the experiments, the dataset assets are also provided through the Hugging Face dataset repository \href{https://huggingface.co/datasets/U-Kaushik/CV-Project-Data}{U-Kaushik/CV-Project-Data}. This separation keeps the codebase lightweight while making the experimental data and supporting files accessible from a dedicated data hosting platform.
